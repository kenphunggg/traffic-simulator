...
INVOCATION_FILE_LOCATION = 'lamda_5.csv'
...
class User1(HttpUser):
    ...
    def wait_time(self):
        ...
        current_time = time()
        if self.invocations_column == 1 or current_time - self.start_time >= STEP_TIME:
